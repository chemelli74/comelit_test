...
from .const import _LOGGER, DOMAIN, SCAN_INTERVAL, DeviceType
...
class ComelitBaseCoordinator(DataUpdateCoordinator[T]):
    ...
    async def _async_remove_stale_devices(
        self,
        previous_list: Mapping[int, DeviceType],
        current_list: Mapping[int, DeviceType],
        dev_type: str,
    ) -> None:
